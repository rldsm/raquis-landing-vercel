      ...
      <main class="page">
        ...
        <section class="wrap hero">
          <div class="hero-copy">
            ...
            <h1><span class="accent hero-off">${c.discount} OFF</span><span class="hero-service">en tu sesión</span></h1>
