    ...
    render() {
      ...
      <style>
        ...
        *,*:before,*:after{box-sizing:border-box}img,video{display:block;max-width:100%}a{color:inherit}.page{overflow:hidden;background:linear-gradient(180deg,#fffaf6 0,#fff 43%,#fffaf6 100%)}.wrap{width:min(1320px,calc(100% - 64px));margin:auto}.brand{padding:26px 0 10px}.brand img{width:230px;height:auto}:host([hide-brand]) .brand{display:none}
        .hero{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(390px,.92fr);gap:48px;align-items:center;padding:42px 0 64px}.hero-copy{text-align:left}.eyebrow{margin:0 0 18px;color:var(--o);font-weight:850;font-size:1rem;letter-spacing:.01em;text-align:left}.hero h1{max-width:720px;margin:0;font-size:clamp(3rem,5.25vw,5rem);line-height:.98;letter-spacing:-.05em;font-weight:820;text-align:left}.hero-off,.hero-service,.hero-type{display:block}.hero-service,.hero-type{margin-top:.05em}.accent{color:var(--o)}.sub{max-width:650px;margin:20px 0 0;color:#5d5651;font-size:clamp(1.08rem,1.6vw,1.3rem);text-align:left}
        .price{display:grid;grid-template-columns:1fr 1.25fr;max-width:580px;margin:30px 0 20px;border:1px solid #ecd2c1;border-radius:18px;background:#fff;overflow:hidden;box-shadow:0 12px 30px rgba(65,40,25,.06)}.price>div{padding:18px 22px;text-align:center}.price>div+div{border-left:1px solid #ecd2c1}.label{display:block;margin-bottom:5px;font-size:.92rem;font-weight:650;color:#625a55}.old{text-decoration:line-through;color:#68615c;font-size:1.8rem}.promo{display:block;color:var(--o);font-size:clamp(2.45rem,4vw,3.65rem);line-height:1;font-weight:850;letter-spacing:-.04em;white-space:nowrap}
        .loc{display:flex;align-items:center;justify-content:flex-start;gap:9px;flex-wrap:wrap;margin:0 0 20px;font-weight:700;font-size:.96rem;text-align:left}.loc svg{color:var(--o)}.sep{color:#aaa19b;font-weight:400}.cta{display:inline-flex;align-items:center;justify-content:center;gap:12px;width:min(100%,580px);min-height:60px;padding:16px 24px;border-radius:13px;background:linear-gradient(#e95608,#da4803);color:white;text-decoration:none;font-weight:850;font-size:1.12rem;box-shadow:0 10px 22px rgba(190,61,2,.2);transition:.15s}.cta:hover{transform:translateY(-1px);box-shadow:0 14px 28px rgba(190,61,2,.25)}.hero-copy>.cta{display:flex;margin-left:0;margin-right:0}
        .promo-note{max-width:580px;margin:15px 0 0;padding:14px 16px;border-radius:12px;background:#fff4ec;border:1px solid #f1d7c6;color:#5f5650;font-size:.9rem;line-height:1.45}.promo-note strong{color:var(--ink)}.promo-note .note-body{display:block;margin-top:4px;color:#5f5650;font-size:inherit}.promo-note .terms{display:block;margin-top:5px;color:#80766f;font-size:.82rem}.hero-copy .promo-note{text-align:left;margin-left:0;margin-right:0}.micro{max-width:580px;margin:8px 0 0;text-align:left;color:#7a736e;font-size:.8rem}
      ...
      <main class="page">
        ...
        <section class="wrap hero">
          <div class="hero-copy">
            ...
            <h1><span class="accent hero-off">${c.discount} OFF</span><span class="hero-service">en tu sesión de</span><span class="hero-type">quiropráctica</span></h1>
            ...
            <a class="cta js-cta" data-pos="hero" href="${c.booking}" target="_blank" rel="noopener noreferrer">AGENDAR SESIÓN →</a>
            <div class="promo-note"><strong>¿Cómo funciona?</strong><span class="note-body">Solo debes agendar tu sesión. Al momento de pagar en recepción, se aplicará un ${c.discount} de descuento.</span><span class="terms">*No acumulable con otras promociones ni descuentos.</span></div>
        ...
        <section class="section"><div class="wrap">
          <h2 class="title">¿Es tu primera vez en Raquis?</h2><p class="intro">En tu primera sesión, de aproximadamente <strong>30 minutos</strong>, evaluamos tu condición antes de definir el tratamiento.</p>
          <div class="steps">
        ...
        <section class="section video-sec"><div class="wrap video-grid">
          ...
          <div class="video-copy"><h2>Conoce cómo es una primera atención en Raquis</h2><p>Paz Grifferos te muestra qué hacemos durante tu primera sesión y cómo evaluamos tu condición antes del tratamiento.</p><a class="cta js-cta" data-pos="video" href="${c.booking}" target="_blank" rel="noopener noreferrer">AGENDAR SESIÓN →</a></div>
        </div></section>
        <section class="wrap final"><div class="final-box"><h2>Agenda tu sesión con <strong>${c.discount} OFF</strong></h2><p class="final-price"><s>${clp(c.regular)}</s> · <strong>${clp(c.promo)} todos los martes de septiembre</strong></p><a class="cta js-cta" data-pos="final" href="${c.booking}" target="_blank" rel="noopener noreferrer">AGENDAR SESIÓN →</a><div class="promo-note"><strong>¿Cómo funciona?</strong><span class="note-body">Solo debes agendar tu sesión. Al momento de pagar en recepción, se aplicará el ${c.discount} de descuento.</span><span class="terms">*No acumulable con otras promociones ni descuentos.</span></div><div class="final-loc">Providencia <span>·</span> Santiago Centro <span>·</span> Todos los martes de septiembre</div></div></section>
        <div class="sticky"><a class="cta js-cta" data-pos="sticky_mobile" href="${c.booking}" target="_blank" rel="noopener noreferrer">AGENDAR SESIÓN</a></div>
      </main>`;
    }
